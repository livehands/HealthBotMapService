...
{
    public static class NearbyHospitalsGoogle
    {
        [FunctionName("NearbyHospitalsGoogle")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "google/{latitude}/{longitude}")] HttpRequest req,
            double latitude,
            double longitude,
            ILogger log)
        {
